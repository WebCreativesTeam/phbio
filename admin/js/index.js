...
})({"bEyVM":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "4ff364c28d3dbb95";
"use strict";
...
var _lang = require("./components/lang");
...
exports.default = ({ initLinks = [], initMax })=>({
        ...
        uploadImage (linkId) {
            ...
            .then((data)=>{
                if (data.success) // Assuming the server returns an object with a 'fileUrl' property
                this.links = this.links.map((link)=>{
                    console.log(data);
                    if (link.id === linkId) {
                ...
                else console.error("Error uploading file:", data.data);
            }).catch((error)=>{
        ...
        handleDragStart (event, id) {
            ...
            if (listItem) // Use the entire list item as the drag image
        ...
        handleDrop (event, id) {
            ...
            const dropTarget = event.target.tagName === "li" ? event.target : event.currentTarget;
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = ({ selected = "", allowMultiple = false })=>({
        isOpen: false,
        allowMultiple,
        ...
        canOpenDropdown () {
            return this.allowMultiple && this.selected.length < 2 || this.selected.length === 0;
        },
        selectOption (option) {
            if (this.allowMultiple) {
                if (!this.selected.includes(option) && this.selected.length < 2) this.selected.push(option);
                else this.selected = this.selected.filter((sel)=>sel !== option);
            } else this.selected = [
                option
            ];
            this.isOpen = false;
...
window.onload = function() {
    ...
    if (th_views) {
        ...
        var svgString = '<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512" class="ctr-table-icon" fill="currentColor"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zm0-352a96 96 0 1 1 0 192 96 96 0 1 1 0-192z"></path></svg>';
...
function checkEmptyTable(tableID) {
    ...
    if (tbody && tbody.children.length === 0) isEmpty = true;
    return isEmpty;
}
...
function initializeAcfDrags() {
    ...
    var acfInputs = document.querySelectorAll("#AcfFormsArea .fields-block-item:not(.fields-block-condition) .acf-input");
    var acfLabels = document.querySelectorAll("#AcfFormsArea .fields-block-item:not(.fields-block-condition) .acf-label");
...
function applyAcfDrags() {
    ...
    forms.forEach((form)=>{
        ...
        const fieldOrder = existingOrder ? JSON.parse(existingOrder)[formId] || CreateFieldOrder() : CreateFieldOrder();
        ...
        const RearrangeFields = (e, dataName)=>{
            ...
            if (!nextSibling) {
                ...
                if (field === nextSibling.attributes["data-name"].value) list.push(draggingItem.attributes["data-name"].value);
                if (field !== draggingItem.attributes["data-name"].value) list.push(field);
                return list;
            }, []);
