...
${frame.code}`;
    ...
    iym3p: [
      ...
      { "./vendors/alpine": "eCjjK", "./vendors/wpdataTables": "aGF4C" },
    ],
    eCjjK: [
      function (require, module, exports) {
        ...
        var _socialLinksNewDefault =
          parcelHelpers.interopDefault(_socialLinksNew);
        ...
        (0, _alpinejsDefault.default).data("dataList", (initLinks = []) =>
          (0, _linksDefault.default)(initLinks)
        );
        (0, _alpinejsDefault.default).data(
          "dropdown",
          (initIcons = [], selected = "") =>
            (0, _dropdownDefault.default)(initIcons, selected)
        );
        (0, _alpinejsDefault.default).data(
          "lang",
          (allowMultiple = false, selected = "") =>
            (0, _langDefault.default)(allowMultiple, selected)
        );
        (0, _alpinejsDefault.default).data("socialLinks", (initLinks = []) =>
          (0, _socialLinksNewDefault.default)(initLinks)
        );
        (0, _alpinejsDefault.default).data("analyticsFilter", () =>
          (0, _analyticsFilter.analyticsFilter)()
        );
        (0, _alpinejsDefault.default).data("dashboard", () =>
          (0, _dashboard.dashboard)()
        );
        (0, _alpinejsDefault.default).data("linkManager", () =>
          (0, _linkManager.linkManager)()
        );
        (0, _alpinejsDefault.default).start();
      },
      {
        alpinejs: "69hXP",
        "./components/links": "gsPSq",
        "./components/analytics-filter": "fI1UE",
        "./components/social-links-new": "gu8G2",
        "./components/dashboard": "lcv74",
        "./components/dropdown": "h4fl0",
        "./components/lang": "bpmMv",
        "./components/link-manager": "hlcQ7",
      ...
      function (require, module, exports) {
        ...
        exports.default = ({ initLinks = [], initMax }) => ({
          ...
          toggleHideLink(id) {
            ...
            console.log(
              "Updated links after toggling hidden state:",
              this.links
            );
          },
          linkIsHidden(id) {
            ...
            if (
              ...
              this.links = this.links.map((item) => {
                return {
                  ...
                  imageFile:
                    item.id === id ? this.inputEditImageFile : item.imageFile,
                  isEditing: false,
                };
              });
              this.linkError = "";
      ...
      function (require, module, exports) {
        ...
        exports.default = ({ initLinks = [] }) => ({
          ...
          handleDrop(event, id) {
            ...
            const [originComponentId, originLinkId] =
              transferredData.split("|");
    ...
    aGF4C: [
      function (require, module, exports) {
        window.onload = function () {
          ...
          var th_empty_clicks = document.querySelector(
            "th.column-empty_clicks"
          );
