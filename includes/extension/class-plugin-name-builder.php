...
class Press_Kit_Builder {
    ...
    const LANG_CHANGE_NOTICE= "<a href='/pricing' class='text-gray-700 no-underline font-semi-bold' target='___blank'>Update twice for language changes to take place</a>";
