...
class Press_Kit_Builder {
    ...
    const LANG_CHANGE_NOTICE= "<a class='text-gray-700 no-underline pointer-events-none font-semi-bold'>Update twice in order to change language!</a>";
    ...
    public static function language_select($name, $value, $label, $capability, $target_user_id) {
        ...
        // echo '<div class="warning-message"><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 warning-icon" viewBox="0 0 24 24" fill="currentColor"><path d="M12,2A10,10,0,1,0,22,12,10.01114,10.01114,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8.00917,8.00917,0,0,1,12,20Zm0-8.5a1,1,0,0,0-1,1v3a1,1,0,0,0,2,0v-3A1,1,0,0,0,12,11.5Zm0-4a1.25,1.25,0,1,0,1.25,1.25A1.25,1.25,0,0,0,12,7.5Z"></path></svg><span>' . self::LANG_CHANGE_NOTICE . '</span></div>';
        ...
        <div class="flex flex-col items-start gap-3 mb-6 sm:items-center sm:flex-row">
            <span class="block text-sm text-gray-500 hover:text-gray-700" x-text="`<?php echo esc_js(site_url('/presskit')); ?>/` + <?php echo get_user_meta($target_user_id, 'pkit_username', true); ?>"></span>
