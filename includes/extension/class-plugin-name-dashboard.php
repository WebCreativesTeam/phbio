            ...
            <?php } ?>
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    if (isset($_POST['date_from']) && isset($_POST['date_to'])) {
                        ...
                        echo "<div class='table-wrapper'>";     
                        echo do_shortcode('[wpdatatable id=31 var3=' . $date_from . ' var4=' . $date_to . ']');
                        echo "</div>";
        ...
        <div x-data="analyticsFilter()" x-init="init" x-cloak>
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                if (isset($_POST['date_from']) && isset($_POST['date_to'])) {
                    ...
                    if(Plugin_Name_Utilities::is_full_version($user_id)) {   
                        echo "<div class='chart-wraper'>";     
                        echo do_shortcode('[wpdatachart id=14]');
                        echo "</div>";
                        echo Plugin_Name_Utilities::is_empty_chart('area', 26, 14);
                    } else {
                        echo "<div class='chart-wraper'>";     
                        echo do_shortcode('[wpdatachart id=13]');
                        echo "</div>";
                        echo Plugin_Name_Utilities::is_empty_chart('area', 25, 13);
                    }
                    ...
                    if(Plugin_Name_Utilities::is_full_version($user_id)) {
                        ...
                        echo "<div class='chart-wraper'>";        
                        echo do_shortcode('[wpdatachart id=15]');
                        echo "</div>";
                        echo Plugin_Name_Utilities::is_empty_chart('pie', 13, 15);
                        ...
                        ?>   
                        <?php $location_img = plugin_dir_url( __FILE__ , 1) . 'img/location.jpg'; ?>
                    ...
                    echo "<div class='hidden'>";
                    echo "<div class='table-wrapper'>";     
                    echo do_shortcode('[wpdatatable id=25 var1=' . $child_post_ids[0] . ' var3=' . $date_from . ' var4=' . $date_to . ']');
                    echo "</div>";
                    echo Plugin_Name_Utilities::is_empty_table(25);
                    
                    echo "<div class='table-wrapper'>";     
                    echo do_shortcode('[wpdatatable id=26 var1=' . $child_post_ids[0] . ' var2=' . $child_post_ids[1] . ' var3=' . $date_from . ' var4=' . $date_to . ']');
                    echo "</div>";
                    echo Plugin_Name_Utilities::is_empty_table(26);

                    echo "<div class='table-wrapper'>";     
                    echo do_shortcode('[wpdatatable id=13 var1=' . $child_post_ids[0] . ' var2=' . $child_post_ids[1] . ' var3=' . $date_from . ' var4=' . $date_to . ']');
                    echo "</div>";
                    echo Plugin_Name_Utilities::is_empty_table(13);
                ...
                echo "<div class='table-wrapper'>";     
                echo do_shortcode('[wpdatatable id=25 var1=' . $child_post_ids[0] . ' var3=' . date("Y-m-d") . ' var4=' . date("Y-m-d") . ']');
                echo "</div>";
                echo Plugin_Name_Utilities::is_empty_table(25);

                echo "<div class='table-wrapper'>";     
                echo do_shortcode('[wpdatatable id=26 var1=' . $child_post_ids[0] . ' var2=' . $child_post_ids[1] . ' var3=' . date("Y-m-d") . ' var4=' . date("Y-m-d") . ']');
                echo "</div>";
                echo Plugin_Name_Utilities::is_empty_table(26);

                echo "<div class='table-wrapper'>";     
                echo do_shortcode('[wpdatatable id=13 var1=' . $child_post_ids[0] . ' var2=' . $child_post_ids[1] . ' var3=' . date("Y-m-d") . ' var4=' . date("Y-m-d") . ']');
                echo "</div>";
                echo Plugin_Name_Utilities::is_empty_table(13);
