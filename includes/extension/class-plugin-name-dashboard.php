...
<div x-data="dashboard" 
    ...
    <div x-show="(activeTab === 'profile' || activeTab === 'forms') && !showTemplates && !showSettings" class="pb-6 -mt-12 tab-content md:pt-5 md:px-4">
        <p>Head to our </p>
        <a href="https://produchertz.com/how-to-tools" class="text-[#F1441E] font-bold" target="_blank" rel="nofollow">Help Page</a> 
        <p>to get started!</p>
    </div>
