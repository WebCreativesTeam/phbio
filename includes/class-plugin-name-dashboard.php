        ...
        <div x-data="analyticsFilter()" x-init="init" x-cloak>
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                if (isset($_POST['date_from']) && isset($_POST['date_to'])) {
                    ...
                    echo do_shortcode('[wpdatachart id=7 var1=test-new var2=' . $date_from . ' var3=' . $date_to . ']');
                ...
                echo do_shortcode('[wpdatachart id=7 var1=test-new var2=1970-01-01 var3=' . date("Y-m-d") . ']');
