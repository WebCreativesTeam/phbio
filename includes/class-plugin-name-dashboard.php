        ...
        <?php
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                if (isset($_POST['date_from']) && isset($_POST['date_to'])) {
                    ...
                    // Performance
                    if(Plugin_Name_Utilities::is_full_version()) {
                    ...
                    if(Plugin_Name_Utilities::is_full_version()) {
                        ...
                        // echo do_shortcode('[wpdatatable id=3 var1=' . $date_from . ' var2=' . $date_to . ' var3=' .  . ']');
                    ...
                    // echo "<div class='table-wrapper'>";     
                    // echo do_shortcode('[wpdatatable id=6 var1=' . $date_from . ' var2=' . $date_to . ' var3=' .  . ']');
                    // echo "</div>";
                ...
                echo "<div class='table-wrapper'>";        
                if(Plugin_Name_Utilities::is_full_version()) {
                    // echo do_shortcode('[wpdatatable id=2 var1=' . date("Y-m-d") . ' var2=' . date("Y-m-d") . ' var3=' .  . ']');
                } else {
                    // echo do_shortcode('[wpdatatable id=3 var1=' . date("Y-m-d") . ' var2=' . date("Y-m-d") . ' var3=' .  . ']');
                }
                echo "</div>";
                echo Plugin_Name_Utilities::is_empty_table(2);
                echo Plugin_Name_Utilities::is_empty_table(3);
                ...
                // echo "<div class='table-wrapper'>";     
                // echo do_shortcode('[wpdatatable id=6 var1=' . date("Y-m-d") . ' var2=' . date("Y-m-d") . ' var3=' .  . ']');
                // echo "</div>";
                // echo Plugin_Name_Utilities::is_empty_table(6);
